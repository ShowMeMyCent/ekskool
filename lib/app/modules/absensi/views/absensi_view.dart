                          ...
                          builder: (context, snapshot) {
                            ...
                            return DropdownSearch<Map<String, dynamic>>(
                              ...
                              onChanged: (Map<String, dynamic>? newValue) {
                                if (newValue != null) {
                                  controller.setSelectedEkskul(newValue['id']);
                                }
                              },
                                ...
                                child: Align(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        '${controller.selectedTime.value.hour}:${controller.selectedTime.value.minute} ${getAmPmLabel(controller.selectedTime.value)}',
                                        style: GoogleFonts.poppins(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w600,
                                        ),
